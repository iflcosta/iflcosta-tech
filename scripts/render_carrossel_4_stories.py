...
def render_carrossel():
    ...
    print("==================================================")
    print("Renderizando Carrossel de 4 Stories 9:16 com Playwright...")
    print(f"Origem do Template: {html_path}")
    print("==================================================")

    with sync_playwright() as p:
        browser = p.chromium.launch()
        page = browser.new_page(viewport={'width': 1400, 'height': 8500, 'device_scale_factor': 1})
    ...
    print("\nTodos os 4 Stories do Carrossel foram renderizados e copiados com sucesso!")
