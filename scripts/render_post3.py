...
html_path = os.path.abspath('assets/carrossel_post3.html')
output_dir = os.path.abspath('assets/img/posts/post3')
...
print("Todos os 5 slides do Post 3 foram gerados com sucesso em 1080x1350px!")
